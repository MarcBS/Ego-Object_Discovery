...
reload_features_scenes = true; % recalculate features of each scene candidate
...
feat_path = [volume_path '/Shared SSD/Object Discovery Data/Video Summarization Objects/Features/Data Narrative_Dataset Ferrari']; % folder where we want to store the features for each object
