...
% dir_root = '/home/marc/Dropbox/Video Summarization Project/Code/Objectness Measure/objectness-release-v2.2';%change 'pwd' to an absolute path
dir_root = [pwd '/Objectness Ferrari/objectness-release-v2.2'];
